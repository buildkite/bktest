...
module Buildkite::TestCollector
  module OTel
    ...
    class << self
      ...
      def configure!(endpoint: DEFAULT_ENDPOINT, api_token: nil, run_env: {}, tags: {})
        if enabled?
        ...
        configure_child_export(endpoint, headers, resource)
      ...
      def configure_child_export(endpoint, headers, resource)
